...
(
    ...
    localparam PAD3 = log2ceil(64'h11240 - 64'h11200); 
    localparam PAD4 = log2ceil(64'h11250 - 64'h11248); 
    // -------------------------------------------------------
    // Work out which address bits are significant based on the
    // address range of the slaves. If the required width is too
    // large or too small, we use the address field width instead.
    // -------------------------------------------------------
    localparam ADDR_RANGE = 64'h11250;
    ...
    // ( 0x11248 .. 0x11250 )
    if ( {address[RG:PAD4],{PAD4{1'b0}}} == 17'h11248   ) begin
